...
// Create a new product. The +7% selling-price margin is applied here (and only
// here) before POST — the value stored in the DB is the marked-up customer-facing
// price. Edits via ProductEditModal do NOT re-apply the margin.
//
// onDone receives the raw API row.

export function ProductCreateModal({ onClose, onDone }) {
    ...
    try {
      ...
      const res = await authFetch('/api/products', {
        ...
        body: JSON.stringify({
          ...
          usd_price:      applyMargin(form.usd_price),
